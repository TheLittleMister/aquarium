...
urlpatterns = [
    ...
    path('change_exception/<int:student_id>',
         change_exception, name="change_exception"),
    ...
    path('level_info/<int:student_level_id>',
         level_info, name="level_info"),

    path('edit_level/<int:student_level_id>',
         edit_level, name="edit_level"),

    path('deactivate_level/<int:student_level_id>',
         deactivate_level, name="deactivate_level"),


    # Attendances Paths
    path('load_future_attendances/', load_future_attendances,
    ...
    path('change_attendance/<int:attendance_id>',
         change_attendance, name="change_attendance"),

    path('change_quota/<int:attendance_id>',
         change_quota, name="change_quota"),

    path('attendance_info/<int:attendance_id>',
         attendance_info, name="attendance_info"),

    path('change_cycle/<int:attendance_id>',
         change_cycle, name="change_cycle"),

    path('change_day/<int:attendance_id>',
         change_day, name="change_day"),

    path('edit_attendance/<int:attendance_id>',
         edit_attendance, name="edit_attendance"),
    ...
    # Certificate Paths
    path("generate_certificate/<int:student_level_id>",
         generate_certificate, name="generate_certificate"),

    path("delete_certificate/<int:student_level_id>",
         delete_certificate, name="delete_certificate"),
