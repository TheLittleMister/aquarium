...
urlpatterns = [
    ...
    path("student/delete/<int:account_id>",
    ...
    path("course/print/search/<int:course_id>",
         print_search, name="print_search"),
    ...
    path("course/attendance/<int:course_id>",
         attendance_course, name="attendance_course"),
    path("attendance/<int:attendance_id>",
         attendance, name="attendance"),  # FETCH
    ...
    path("courses/past/<int:account_id>",
         past_student_courses, name="past_student_courses"),
    path("courses/next/<int:account_id>",
         next_student_courses, name="next_student_courses"),
    ...
    path("update_first_name/<int:account_id>",
         update_first_name, name="update_first_name"),
    path("reject_first_name/<int:account_id>",
         reject_first_name, name="reject_first_name"),

    path("update_last_name/<int:account_id>",
         update_last_name, name="update_last_name"),
    path("reject_last_name/<int:account_id>",
         reject_last_name, name="reject_last_name"),

    path("update_id/<int:account_id>", update_id, name="update_id"),
    path("reject_id/<int:account_id>", reject_id, name="reject_id"),

    path("update_phone_1/<int:account_id>",
         update_phone_1, name="update_phone_1"),
    path("reject_phone_1/<int:account_id>",
         reject_phone_1, name="reject_phone_1"),

    path("update_phone_2/<int:account_id>",
         update_phone_2, name="update_phone_2"),
    path("reject_phone_2/<int:account_id>",
         reject_phone_2, name="reject_phone_2"),
