...
def index(request, account_id):
    ...
    if request.user == student:
        ...
        if request.method == "POST":
            ...
            student.parent = unidecode.unidecode(
                request.POST["parent"]).upper()
