...
class Account(AbstractBaseUser):
    ...
    parent = models.CharField("Acudiente", max_length=60, null=True, blank=True)
    ...
    first_name_1 = models.CharField("Nombres", max_length=30, default="", null=True)
    last_name_1 = models.CharField("Apellidos", max_length=30, default="", null=True)
    identity_document_1 = models.BigIntegerField(
        "Número de Documento", unique=True, null=True
    )  # ID
