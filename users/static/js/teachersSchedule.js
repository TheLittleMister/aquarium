...
function getSchedule(user_id) {
	$.ajax({
		type: "GET",
		url: "https://www.aquariumschool.co/users/create_schedule/",
		data: {
			userID: user_id,
		},
		beforeSend: function () {
				...
				for (var i = 2; i < response["schedule"][scheduleID].length; i++) {
					if (response["schedule"][scheduleID][i] !== "-") {
						...
						if (response["schedule"][scheduleID][i].length > 1) {
							for (
								...
								$(`#scheduleModalBody${scheduleID}${i}`).append(`<tr> \
                                                <td scope="row" data-label="Documento"> \
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i][objID]["id"]}">${response["schedule"][scheduleID][i][objID]["identity_document"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Nombres">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i][objID]["id"]}">${response["schedule"][scheduleID][i][objID]["first_name"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Apellidos">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i][objID]["id"]}">${response["schedule"][scheduleID][i][objID]["last_name"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Tel/Cel (1)">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i][objID]["id"]}">${response["schedule"][scheduleID][i][objID]["phone_1"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Tel/Cel (2)">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i][objID]["id"]}">${response["schedule"][scheduleID][i][objID]["phone_2"]}</a>\
                                                </td>\
                                            </tr>`);
							}
							...
							$(`#scheduleModalBody${scheduleID}${i}`).append(`<tr> \
                                                <td scope="row" data-label="Documento"> \
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i]["id"]}">${response["schedule"][scheduleID][i]["identity_document"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Nombres">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i]["id"]}">${response["schedule"][scheduleID][i]["first_name"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Apellidos">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i]["id"]}">${response["schedule"][scheduleID][i]["last_name"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Tel/Cel (1)">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i]["id"]}">${response["schedule"][scheduleID][i]["phone_1"]}</a>\
                                                </td>\
                                                <td scope="row" data-label="Tel/Cel (2)">\
                                                    <a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["schedule"][scheduleID][i]["id"]}">${response["schedule"][scheduleID][i]["phone_2"]}</a>\
                                                </td>\
                                            </tr>`);
...
function load_students_levels(levelID) {
	...
	if (allLevelStudentsLoaded === false) {
		$.ajax({
			type: "GET",
			url: "https://www.aquariumschool.co/users/load_level_students/",
			data: {
				start: start,
				end: end,
				levelID: levelID,
			...
			success: function (response) {
				...
				for (
					...
					$(`#levelTableBody`).append(`<tr> \
									<td scope="row" data-label="Documento"> \
										<a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["students"][studentsID]["student__id"]}">${response["students"][studentsID]["student__identity_document"]}</a>\
									</td>\
									<td scope="row" data-label="Nombres">\
										<a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["students"][studentsID]["student__id"]}">${response["students"][studentsID]["student__first_name"]}</a>\
									</td>\
									<td scope="row" data-label="Apellidos">\
										<a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["students"][studentsID]["student__id"]}">${response["students"][studentsID]["student__last_name"]}</a>\
									</td>\
									<td scope="row" data-label="Tel/Cel (1)">\
										<a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["students"][studentsID]["student__id"]}">${response["students"][studentsID]["student__phone_1"]}</a>\
									</td>\
									<td scope="row" data-label="Tel/Cel (2)">\
										<a target="_blank" href="https://www.aquariumschool.co/users/profile/${response["students"][studentsID]["student__id"]}">${response["students"][studentsID]["student__phone_2"]}</a>\
									</td>\
								</tr>`);
				}
...
$("#levelSearch").keyup(
	delay(function () {
		...
		$.ajax({
			type: "GET",
			url: "https://www.aquariumschool.co/users/search_level_students/",
			data: {
				student: $(this).val(),
				levelID: levelID,
			},
